...
public class Actions_Student : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        School = GameObject.Find("School").GetComponent<Transform>().transform;
    ...
    void Update()
    {
        ...
        switch (State){
            ...
            case "GoSchool":
                pathfinder.targetPos = School.position;
                break;
            case "GoHome":
            ...
            case "Idle":
                ...
                if (timer < 0)
                {
                    ...
                    {
                        case "School":
                            Vector3 newPos = new Vector3 (School.position.x + Random.Range(-4f, 4f), 0f, School.position.z + Random.Range(-4f,4f));
